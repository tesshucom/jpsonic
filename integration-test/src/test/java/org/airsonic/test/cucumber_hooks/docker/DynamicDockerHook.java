...
public class DynamicDockerHook implements AirsonicServer, EnvironmentAware, InitializingBean, DisposableBean {
    ...
    public static final String JPSONIC_DOCKER_IMAGE = "jpsonic.docker.image";
    public static final String JPSONIC_DOCKER_PORT = "jpsonic.docker.port";
    public static final String JPSONIC_READY_MAX_WAIT = "jpsonic.ready.max_wait";
    public static final String JPSONIC_READY_SLEEP_TIME = "jpsonic.ready.sleep_time";
    ...
    public void startServer() {
        ...
        final String name = "jpsonic-it-" + RandomStringUtils.randomAlphabetic(10);
        try {
    ...
    public void setEnvironment(Environment environment) {
        dockerImage = environment.getRequiredProperty(JPSONIC_DOCKER_IMAGE);
        dockerPort = Integer.parseInt(environment.getRequiredProperty(JPSONIC_DOCKER_PORT));
        readyMaxWaitTime = Long.parseLong(environment.getRequiredProperty(JPSONIC_READY_MAX_WAIT));
        readySleepTime = Long.parseLong(environment.getRequiredProperty(JPSONIC_READY_SLEEP_TIME));
