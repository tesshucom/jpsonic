 ...
 */
public class PlaylistUpnpProcessorTestCase extends AbstractAirsonicHomeTest {
    ...
    public void setup() throws Exception {
        ...
        if (0 == playlistDao.getAllPlaylists().size()) {
            ...
            shallow.addAll(JpsonicComparatorsIntegrationTest.jPSonicNaturalList);
    ...
    public void testGetItems() {
        ...
        Map<String, Playlist> c = new HashMap<>();
    ...
    public void testGetChildren() {
        ...
        Map<Integer, MediaFile> c = new HashMap<>();
