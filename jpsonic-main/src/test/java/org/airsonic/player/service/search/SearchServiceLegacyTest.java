...
public class SearchServiceLegacyTest extends AbstractNeedsScan {
    ...
    public void testSearchTypical() throws IOException {
        ...
        result = searchService.search(searchCriteria);
        assertEquals(4, result.getTotalHits(), "(29) Specify '" + searchCriteria.getQuery() + "', total Hits is");
        ...
        assertEquals(1L, l, "(34) Artist whose name is \"_ID3_ARTIST_\" is 1 records.");
