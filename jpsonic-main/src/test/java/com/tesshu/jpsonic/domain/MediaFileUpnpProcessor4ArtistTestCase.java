...
public class MediaFileUpnpProcessor4ArtistTestCase extends AbstractAirsonicHomeTest {
    ...
    public void testGetAllItems() {
        List<MediaFile> artists = mediaFileUpnpProcessor.getAllItems();
        assertEquals(20, artists.size());
        assertTrue(validateJPSonicNaturalList(artists.stream().map(a -> a.getName()).collect(Collectors.toList())));
    }
