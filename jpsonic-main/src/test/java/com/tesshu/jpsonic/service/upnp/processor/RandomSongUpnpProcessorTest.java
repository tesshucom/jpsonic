...
class RandomSongUpnpProcessorTest {

    private SearchService searchService;
    private SettingsService settingsService;
    private RandomSongUpnpProcessor proc;

    @BeforeEach
    public void setup() {
        searchService = mock(SearchService.class);
        settingsService = mock(SettingsService.class);
        proc = new RandomSongUpnpProcessor(mock(UpnpProcessorUtil.class), mock(UpnpDIDLFactory.class),
