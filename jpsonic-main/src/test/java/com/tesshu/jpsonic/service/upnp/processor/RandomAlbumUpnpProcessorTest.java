...
class RandomAlbumUpnpProcessorTest {

    private SearchService searchService;
    private SettingsService settingsService;
    private RandomAlbumUpnpProcessor proc;

    @BeforeEach
    public void setup() {
        searchService = mock(SearchService.class);
        settingsService = mock(SettingsService.class);
        proc = new RandomAlbumUpnpProcessor(mock(UpnpProcessorUtil.class), mock(UpnpDIDLFactory.class),
