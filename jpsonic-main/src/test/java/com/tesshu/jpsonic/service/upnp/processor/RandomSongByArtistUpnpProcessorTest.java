...
class RandomSongByArtistUpnpProcessorTest {
    ...
    class UnitTest {
        ...
        private RandomSongByArtistUpnpProcessor proc;
        ...
        public void setup() {
            ...
            proc = new RandomSongByArtistUpnpProcessor(util, factory, artistDao, searchService, settingsService);
        }
