...
class RecentAlbumId3UpnpProcessorTest {

    @Nested
    class UnitTest {

        private AlbumDao albumDao;
        private RecentAlbumId3UpnpProcessor proc;
        ...
        public void setup() {
            ...
            proc = new RecentAlbumId3UpnpProcessor(util, factory, mediaFileService, albumDao);
        }
