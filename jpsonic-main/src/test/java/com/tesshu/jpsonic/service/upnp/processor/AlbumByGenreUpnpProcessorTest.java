...
class AlbumByGenreUpnpProcessorTest {
    ...
    private AlbumByGenreUpnpProcessor proc;
    ...
    public void setup() {
        ...
        proc = new AlbumByGenreUpnpProcessor(util, factory, mediaFileService, searchService);
    }
