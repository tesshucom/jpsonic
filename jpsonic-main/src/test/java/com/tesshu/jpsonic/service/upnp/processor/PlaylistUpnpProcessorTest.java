...
class PlaylistUpnpProcessorTest {
    ...
    class UnitTest {
        ...
        private PlaylistUpnpProcessor proc;
        ...
        public void setup() {
            ...
            proc = new PlaylistUpnpProcessor(factory, playlistService);
        }
    ...
    class IntegrationTest extends AbstractNeedsScan {
        ...
        void testCreateContainer() {
            ...
            Container container = playlistUpnpProcessor.createContainer(playlist);
