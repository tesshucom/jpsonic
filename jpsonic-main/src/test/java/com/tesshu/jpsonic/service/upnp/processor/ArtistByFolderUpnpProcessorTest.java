...
class ArtistByFolderUpnpProcessorTest {

    private UpnpProcessorUtil util;
    private ArtistDao artistDao;
    private AlbumDao albumDao;
    private FolderOrArtistLogic folderOrArtistProc;
    private ArtistByFolderUpnpProcessor proc;
    ...
    public void setup() {
        ...
        proc = new ArtistByFolderUpnpProcessor(util, factory, artistDao, albumDao, folderOrArtistProc);
    }
    ...
    void testAddChild() {
        ...
        proc = new ArtistByFolderUpnpProcessor(util, mock(UpnpDIDLFactory.class), artistDao, albumDao,
                folderOrArtistProc);
