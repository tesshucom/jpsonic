...
class RandomSongByFolderArtistProcTest {
    ...
    class UnitTest {
        ...
        void setup() {
            ...
            proc = new RandomSongByFolderArtistProc(musicFolderProvider, artistProvider,
                    mediaSearchProvider, folderOrArtistProc, settingsFacade, factory);
        }
        ...
        void testGetChildrenWithFolder() {
            ...
            MusicFolder folder = new MusicFolder(0, "/folder1", "folder1", false, now(), 0, false);
