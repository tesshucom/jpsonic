...
<ul class="controls">
    <c:choose>
        <c:when test="${model.viewAsList}">
            <li><span title="<fmt:message key='common.viewaslist'/>" class="control list selected"><fmt:message key='common.viewaslist'/></span></li>
        ...
        <c:otherwise>
            ...
            <li><span title="<fmt:message key='common.viewasgrid'/>" class="control tile selected"><fmt:message key='common.viewasgrid'/></span></li>
        </c:otherwise>
    </c:choose>
</ul>
