...
<section>
    <h1><img src="<spring:theme code='uploadImage'/>"/><fmt:message key="more.upload.title"/></h1>
</section>
...
<form method="post" enctype="multipart/form-data" action="upload.view?${_csrf.parameterName}=${_csrf.token}">
	        ...
	        <dl>
                ...
                <dd><input type="file" id="file" name="file" size="40"/></dd>
	            <dt><fmt:message key="more.upload.target"/></dt>
	            <dd><input type="text" id="dir" name="dir" size="37" value="${model.uploadDirectory}"/></dd>
	            <dt></dt>
