        ...
        <table class="tabular songs">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <c:if test="${model.visibility.artistVisible}"><td class="${artistClass}"><span>${fn:escapeXml(song.artist)}</span></td></c:if>
                    ...
                    <c:if test="${model.visibility.fileSizeVisible}"><td class="${suppl} size"><sub:formatBytes bytes="${song.fileSize}"/></td></c:if>
