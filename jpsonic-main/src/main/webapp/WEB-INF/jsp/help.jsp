...
<table width="75%" class="ruleTable indent">
    ...
    <tr><td class="ruleTableHeader"><fmt:message key="help.version.title"/></td><td class="ruleTableCell">Jpsonic 2.2.3 cloned version of Airsonic ${versionString} &ndash; ${buildDateString}</td></tr>
