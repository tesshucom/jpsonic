...
<details>
	...
	<form action="javascript:search()">
		...
		<dl>
			...
			<dd><input id="artist" name="artist" placeholder="<fmt:message key='changecoverart.artist'/>" size="35" type="text" value="${model.artist}" onclick="select()"/></dd>
			<dt><fmt:message key='changecoverart.album'/></dt>
	        <dd><input id="album" name="album" placeholder="<fmt:message key='changecoverart.album'/>" size="35" type="text" value="${model.album}" onclick="select()"/></dd>
	    </dl>
	    <div class="submits">
...
<details>
	...
	<form action="javascript:setImage(dwr.util.getValue('url'))">
	    ...
	    <dl>
	    	...
	    	<dd><input type="text" name="url" size="50" id="url" value="http://" onclick="select()"/></dd>
	    </dl>
	    <div class="submits">
