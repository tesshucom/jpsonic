        ...
        <table class="tabular queue">
            <c:if test="${model.visibility.composerVisible || model.visibility.genreVisible}">
                <thead id="playQueueHeader">
                    <tr>
                        ...
                        <c:if test="${model.visibility.yearVisible}"><th class="supplement year"></th></c:if>
                        <c:if test="${model.visibility.formatVisible}"><th class="supplement format"></th></c:if>
                        <c:if test="${model.visibility.fileSizeVisible}"><th class="supplement size"></th></c:if>
                        <c:if test="${model.visibility.durationVisible}"><th class="supplement duration"></th></c:if>
                        <c:if test="${model.visibility.bitRateVisible}"><th class="supplement bitrate"></th></c:if>
                        <th></th><%-- delete --%>
                    </tr>
                </thead>
            </c:if>
            <tbody id="playQueueBody">
                <tr id="pattern">
                    ...
                    <c:if test="${model.visibility.yearVisible}"><td class="supplement year"><span id="year">Year</span></td></c:if>
                    <c:if test="${model.visibility.formatVisible}"><td class="supplement format"><span id="format">Format</span></td></c:if>
                    <c:if test="${model.visibility.fileSizeVisible}"><td class="supplement size"><span id="fileSize">Format</span></td></c:if>
                    <c:if test="${model.visibility.durationVisible}"><td class="supplement duration"><span id="duration">Duration</span></td></c:if>
                    <c:if test="${model.visibility.bitRateVisible}"><td class="supplement bitrate"><span id="bitRate">Bit Rate</span></td></c:if>
