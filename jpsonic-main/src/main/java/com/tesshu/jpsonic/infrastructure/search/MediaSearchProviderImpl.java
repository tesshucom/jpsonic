 ...
 */
@Service
public class MediaSearchProviderImpl implements MediaSearchProvider, LegacySearch {

    private static final Logger LOG = LoggerFactory.getLogger(MediaSearchProviderImpl.class);
