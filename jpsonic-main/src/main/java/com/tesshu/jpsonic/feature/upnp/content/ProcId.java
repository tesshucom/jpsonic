...
/**
 * Identifies a logical UPnP content hierarchy.
 *
 * <p>
 * A {@code ProcId} serves as the stable identifier that connects a
 * ContentDirectory Object ID namespace with the {@link UPnPContentProcessor}
 * responsible for that namespace. It is also used when constructing Object IDs
 * for containers belonging to the hierarchy.
 * </p>
 *
 * <p>
 * This allows the external UPnP object tree and the internal processor
 * structure to remain aligned without requiring processors to know about one
 * another.
 * </p>
 */
public enum ProcId {
    ...
    /**
     * Resolves a processor ID from its external UPnP identifier.
     *
     * @param s UPnP processor identifier
     * @return the corresponding processor ID
     * @throws NoSuchElementException if the identifier is not defined
     */
