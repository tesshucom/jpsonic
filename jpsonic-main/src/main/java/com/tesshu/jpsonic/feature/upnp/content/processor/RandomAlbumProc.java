...
class RandomAlbumProc extends AlbumId3Proc implements CountLimitProc {
    ...
    RandomAlbumProc(MusicFolderProvider musicFolderProvider, MediaFileProvider mediaFileProvider,
            AlbumProvider albumProvider, MediaSearchProvider mediaSearchProvider,
