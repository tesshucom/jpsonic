...
@Controller
class RootUPnPProc implements UPnPContentProcessor<MenuItem, MenuItem> {

    private final MenuItemService menuItemService;
    private final UPnPContentProcessorResolver upnpContentProcessorResolver;

    RootUPnPProc(MenuItemService menuItemService,
            @Lazy UPnPContentProcessorResolver upnpContentProcessorResolver) {
    ...
    private UPnPContentProcessor<?, ?> findProcessor(MenuItem menuItem) {
        return upnpContentProcessorResolver.findProcessor(ProcId.from(menuItem.getId()));
    }
