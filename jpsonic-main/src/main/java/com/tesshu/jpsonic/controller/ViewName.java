...
public enum ViewName {
    ...
    ADVANCED_SETTINGS(ViewNameConstants.ADVANCED_SETTINGS), AVATAR(ViewNameConstants.AVATAR),
    COVER_ART(ViewNameConstants.COVER_ART), DATABASE_SETTINGS(ViewNameConstants.DATABASE_SETTINGS),
    DLNA_SETTINGS(ViewNameConstants.DLNA_SETTINGS),
    GENERAL_SETTINGS(ViewNameConstants.GENERAL_SETTINGS),
    GETTING_STARTED(ViewNameConstants.GETTING_STARTED), HELP(ViewNameConstants.HELP),
    HOME(ViewNameConstants.HOME),
    INTERNET_RADIO_SETTINGS(ViewNameConstants.INTERNET_RADIO_SETTINGS),
    JUKEBOX_CONTROL(ViewNameConstants.JUKEBOX_CONTROL), LYRICS(ViewNameConstants.LYRICS),
    MAIN(ViewNameConstants.MAIN), MORE(ViewNameConstants.MORE),
    ...
    PLAY_QUEUE(ViewNameConstants.PLAY_QUEUE), PLAYER_SETTINGS(ViewNameConstants.PLAYER_SETTINGS),
    PODCAST(ViewNameConstants.PODCAST), PODCAST_CHANNEL(ViewNameConstants.PODCAST_CHANNEL),
    ...
    public static final class ViewNameConstants {
        ...
        public static final String RANDOM_PLAYQUEUE = "randomPlayQueue.view"; // Used from
                                                                              // annotation
