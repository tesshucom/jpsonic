...
public enum SupportableBCP47 {
    ...
    EN("en-US"), EN_GB("en-GB"), EN_US("en-US"), FR("fr-FR"), ES("es-ES"), CA("ca-ES"), PT("pt-BR"),
    DE("de-DE"), IT("it-IT"), EL("el-GR"), RU("ru-RU"), SL("sl-SI"), MK("mk-MK"), PL("pl-PL"),
    BG("bg-BG"), CS("cs-CZ"), ZH_CN("zh"), ZH_TW("zh-TW"), JA_JP("ja-JP"), KO("ko-KR"), NL("nl-NL"),
    NO("no-NO"), NN("no-NO"), SV("sv-SE"), DA("da-DK"), FI("fi-FI"), IS("is-IS"), ET("et-EE");
