...
public class ScanEvent {
    ...
    public enum ScanEventType {
        FINISHED, FAILED, DESTROYED, BEFORE_SCAN, PARSE_AUDIO, PARSE_PODCAST, PARSED_COUNT, MARK_NON_PRESENT,
        UPDATE_ALBUM_COUNTS, UPDATE_GENRE_MASTER, UPDATE_ORDER, RUN_STATS, IMPORT_PLAYLISTS, CHECKPOINT, AFTER_SCAN
    }
}
