...
public class SearchServiceImpl implements SearchService {
    ...
    public SearchServiceImpl(QueryFactory queryFactory, IndexManager indexManager,
    ...
    public SearchResult search(SearchCriteria criteria) {
        ...
        try {
            ...
            for (int i = start; i < end; i++) {
                util
                    .addIfAnyMatch(result, criteria.getIndexType(),
            ...
            if (settingsService.isOutputSearchQuery() && LOG.isInfoEnabled()) {
                LOG
                    .info("Web: Multi-field search : {} -> query:{}, offset:{}, count:{}",
                            criteria.getIndexType(), criteria.getQuery(), criteria.getOffset(),
                            criteria.getCount());
            }
        ...
        if (settingsService.isOutputSearchQuery() && LOG.isInfoEnabled()) {
            LOG
                .info("UpnP: UpnP-compliant field search : {} -> query:{}, offset:{}, count:{}",
                        indexType, criteria.getQuery(), criteria.getOffset(), criteria.getCount());
        }
    }
