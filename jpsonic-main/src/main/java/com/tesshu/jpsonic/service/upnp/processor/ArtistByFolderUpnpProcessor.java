...
@Service
public class ArtistByFolderUpnpProcessor extends DirectChildrenContentProcessor<FolderOrArtist, ArtistOrAlbum> {
    ...
    public ArtistByFolderUpnpProcessor(UpnpProcessorUtil util, UpnpDIDLFactory factory, ArtistDao artistDao,
