...
@Service
public class IndexId3UpnpProcessor extends DirectChildrenContentProcessor<MusicIndex, Artist> {
    ...
    public IndexId3UpnpProcessor(UpnpProcessorUtil util, UpnpDIDLFactory factory, MusicIndexService musicIndexService,
            ArtistDao artistDao) {
        super();
        this.util = util;
