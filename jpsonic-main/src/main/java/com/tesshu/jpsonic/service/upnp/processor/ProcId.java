...
public enum ProcId {
    ...
    ARTIST("artist"), ARTIST_BY_FOLDER("artistByFolder"), ALBUM_BY_GENRE("abg"), ALBUM_ID3_BY_GENRE("aibg"),
    SONG_BY_GENRE("sbg"), RECENT("recent"), RECENT_ID3("recentId3"), INDEX("index"), INDEX_ID3("indexId3"),
